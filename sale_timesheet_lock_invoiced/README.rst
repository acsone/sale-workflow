...
Forbid to update/delete a timesheet line if it has been invoiced.
*sale_timesheet* module only forbid to edit some fields. This module will block
any update and deletion of invoiced lines.
