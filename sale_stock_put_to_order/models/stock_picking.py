...
class StockPicking(models.Model):
    ...
    def _get_pto_source_products(self):
        ...
        When a sale order is linked, returns the full SO product list
        (including lines not yet delivered) so that bin selection considers
        the complete order context. Falls back to move products otherwise.
        """
        self.ensure_one()
